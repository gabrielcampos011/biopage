    ...
    if (success) {
        return (
            <div className="min-h-screen w-full flex items-center justify-center p-4">
                ...
                <div className="w-full max-w-md bg-gray-800/80 backdrop-blur-xl border border-white/5 shadow-2xl shadow-black/50 rounded-3xl p-8 flex flex-col gap-6 text-center relative z-10">
                    <div className="w-16 h-16 rounded-full bg-green-500/20 flex items-center justify-center text-green-400 mx-auto border border-green-500/30">
                        <Mail size={32} />
                    </div>
